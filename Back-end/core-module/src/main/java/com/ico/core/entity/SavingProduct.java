...
public class SavingProduct {
    ...
    @Builder
    public SavingProduct(Long id, Nation nation, String title, int amount, byte count, byte grade_1, byte grade_2, byte grade_3, byte grade_4, byte grade_5, byte grade_6, byte grade_7, byte grade_8, byte grade_9, byte grade_10) {
        this.id = id;
        this.nation = nation;
        this.title = title;
        this.amount = amount;
    ...
    public void updateSavingProduct(SavingUpdateDto dto){
