...
insert into student_job(id, color, count, credit_rating, detail, image, title, total, wage, nation_id)
VALUES(1, '빨강', 0, 6, '이 분은 소방관', '일러스트...', '소방관', 5, 1000, 99);

insert into student_job(id, color, credit_rating, detail, image, title, total, wage, nation_id)
VALUES(2, '파랑', 6, '이 분은 경찰관', '일러스트...', '경찰관', 3, 1500, 99);
