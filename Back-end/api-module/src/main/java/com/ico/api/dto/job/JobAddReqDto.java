...
public class JobAddReqDto {
    ...
    @Builder
    public JobAddReqDto(String title, String detail, Integer total, Integer wage, String color, Integer creditRating, String image, List<Long> empowered, Map<Long, Integer> jobLicenseList) {
        this.title = title;
        this.detail = detail;
        this.total = total;
        this.wage = wage;
