...
function asset() {
	...
	return (
		<React.Fragment>
			<Modal content={<ModalContent width={'90vw'} title={'정기 예금 신청'} titleSize={'var(--student-h1)'} icon={APPLY_ICON} content={<FinanceDepositApplyModal/>}/>} compState={compState} closeComp={closeComp} transition={"scale"}/>
