...
function RuleClass() {
	...
	return (
		<div css={contentWrapperCSS}>
            <div css={titleCSS}>
                학급 규칙
                <Button text={'추가'} fontSize={'var(--teacher-h5)'} width={'110px'} height={'35px'} theme={'normal'} />
            </div>
            ...
            <RuleClassDetail title={'학급 규칙 제목 2'} content={'학급 규칙 내용입니다. 입섬 로렘...'} date={'2023년 04월 26일'} />
