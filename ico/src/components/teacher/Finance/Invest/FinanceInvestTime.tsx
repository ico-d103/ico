...
function FinanceInvestTime() {
	return (
        <div>   
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DemoContainer
                    components={["DigitalClock", "DigitalClock", "MultiSectionDigitalClock", "MultiSectionDigitalClock"]}
                >
                    ...
                    <DemoContainer components={["MultiSectionDigitalClock", "MultiSectionDigitalClock"]}>
                        <DemoItem label="Multi section digital clock disabled">
                            <MultiSectionDigitalClock defaultValue={dayjs("2022-04-17T15:30")} disabled />
                        </DemoItem>
                        <DemoItem label="Multi section digital clock readOnly">
                            <MultiSectionDigitalClock defaultValue={dayjs("2022-04-17T15:30")} readOnly />
                        </DemoItem>
                    </DemoContainer>
                </DemoContainer>
...
export default FinanceInvestTime
